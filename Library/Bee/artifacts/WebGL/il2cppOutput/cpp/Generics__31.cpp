...
IL_002f:
	...
	}
	{
		...
		bool L_11;
		L_11 = ValueTuple_2_Equals_mA0675CC806BCB3A64EB9271537B7A53FAF1838FF(((L_8)->GetAddressAtUnchecked(static_cast<il2cpp_array_size_t>(L_9))), L_10, il2cpp_rgctx_method(method->klass->rgctx_data, 2));
		if (!L_11)
		{
			goto IL_0056;
		}
